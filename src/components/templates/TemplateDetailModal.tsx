      ...
      <DialogContent className="sm:max-w-[1200px] w-[90vw] h-[90vh] overflow-y-auto">
        ...
        <div className="grid grid-cols-12 gap-8 mt-4">
          ...
          <div className="col-span-8 relative overflow-hidden rounded-lg bg-gray-100 border border-slate-200">
            {allImages.length > 0 ? (
              <div className="relative w-full h-full flex items-start justify-center pt-24"> {/* Updated to pt-24 for ~6cm of top padding */}
              ...
              <div className="aspect-video flex items-center justify-center pt-24"> {/* Updated to pt-24 for ~6cm of top padding */}
